export const selectStyle =
  "block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline py-2";
...
export const tinyButtonStyle =
  "flex align-center bg-yellow-300 hover:bg-yellow-400 text-gray-800 py-1 px-1 m-1 rounded inline-flex items-center";
export const errorFieldStyle =
  "shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline";
export const labelStyle = "block text-gray-700 text-sm font-bold";
export const sectionStyle = "rounded p-2";
